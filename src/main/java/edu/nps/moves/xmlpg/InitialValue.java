...
/**
 * Represents an initial value for a primitive type. This can be set in a
 * subclass of a given class, for example to initialize a header, like version
 * number of packet type.
 *
 * @author DMcG
 */
