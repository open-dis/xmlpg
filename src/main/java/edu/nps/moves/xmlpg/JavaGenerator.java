 ...
 * a source code file in the java language. It has ivars, getters, setters, and
...
public class JavaGenerator extends Generator {
    ...
    /**
     * Some Java (or Java-like) distributions don't have the full Java JDK 1.6
     * stack, such as Android. That means no JAXB, and no Hibernate/JPA. These
     * booleans flip on or off the generation of the annotations that use these
    ...
    /**
     * A property list that contains java-specific code generation information,
     * such as package names, imports, etc.
     */
    ...
    /**
     * Writes the package and package import code at the top of the Java source
     * file
     *
     * @param pw
     * @param aClass
    ...
    private void writeImports(PrintWriter pw, GeneratedClass aClass) {
        ...
        if (this.useJaxbAnnotations || this.useHibernateAnnotations) {
            pw.println("// Jaxb and Hibernate annotations generally won't work on mobile devices. XML serialization uses jaxb, and");
            ...
            pw.println("// see the XMLPG java code generator, and set the boolean useHibernateAnnotations and useJaxbAnnotions ");
    ...
    private void writeClassDeclaration(PrintWriter pw, GeneratedClass aClass) {
        ...
        /**
         * Used in XML marshalling--if this is the top level container, mark up
         * the class for jaxb
         */
    ...
    public void writeGetMarshalledSizeMethod(PrintWriter pw, GeneratedClass aClass) {
        ...
        if (useHibernateAnnotations) {
            pw.println("@Transient  // Marked as transient to prevent hibernate from thinking this is a persistent property");
        }
     ...
     * though inefficient way to marshal a Pdu. Better is to reuse a ByteBuffer
     * and pass it along to the similarly-named method, but still, there's
    ...
    /**
     * Generate a constructor that takes a jaxb-equivalent object and returns an
     * open-dis object
     */
