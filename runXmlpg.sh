...
mvn exec:java -Dexec.mainClass=edu.nps.moves.xmlpg.Xmlpg  -Dxmlpg.generatedSourceDir=target/generated-sources/xmlpg-`basename $schema .xml`-$lang/ -Dexec.args="$schema $lang"
